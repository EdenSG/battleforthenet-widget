...
*/
    var ready = function() {
        ...
        // _bftn_animations.modal.options.modal_hue = _bftn_options.modal_hue;
        // document.getElementById('_bftn_iframe').contentWindow.adjustThemeColor(_bftn_options.modal_hue);
...
var adjustHue = function() {
    document.getElementById('_bftn_iframe').contentWindow.adjustThemeColor(_bftn_options.modal_hue);
}

// document.getElementById('_bftn_iframe').addEventListener('onload', adjustHue(), false )
